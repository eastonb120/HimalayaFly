...
## We are creating a class as an abstraction of items contained in bins.
...
class item:
    ...
    # class attribute methods for __name  
...
######################################################################################################
## Function: quickSort
## Purpose: This is a variation of quickSort. It is used to sort items based on item_number
...
def quickSort(itemList):
    ...
    if len(itemList) <= 1:
        ...
        ## from Python's multiprocessing library would need to be overloaded and tweaked to behave in recursive calls.
        ##
        ## Problem Reformulation - The recursive calls transform a large sort into many smaller sorts.
        ##
